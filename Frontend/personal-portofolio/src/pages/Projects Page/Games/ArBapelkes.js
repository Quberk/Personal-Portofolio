...
const ArBapelkes = () => {
    ...
    const imageUrls = [
        './Projects Image/Games/AR Bapelkes/2.png',
        './Projects Image/Games/AR Bapelkes/3.png',
        './Projects Image/Games/AR Bapelkes/4.png',
        './Projects Image/Games/AR Bapelkes/5.png',
        './Projects Image/Games/AR Bapelkes/6.png',
        './Projects Image/Games/AR Bapelkes/7.png',
        './Projects Image/Games/AR Bapelkes/8.png',
    ];
        ...
        <div className='pt-20 px-10'>
            ...
            <div class="grid grid-cols-2 pb-20 hidden sm:flex">
                ...
                <div class="w-1/2 pl-10">
                    ...
                    <Video
                        video_path = "./Projects Video/Game/AR Bapelkes/AR Bapelkes.mp4"
                        poster_path = "./Projects Image/Games/AR Bapelkes/2.png"
                    />
